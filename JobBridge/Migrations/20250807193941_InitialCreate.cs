        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FieldTitle = table.Column<string>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    ResumeUrl = table.Column<string>(type: "TEXT", maxLength: 2083, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdditionalCompensation = table.Column<string>(type: "TEXT", nullable: false),
                    ...
                    PreferredQualifications = table.Column<string>(type: "TEXT", nullable: false),
                    ...
                    ExternalApplicationUrl = table.Column<string>(type: "TEXT", nullable: true),
                    PostedDate = table.Column<DateTime>(type: "TEXT", nullable: false),
                    ApplicationDeadline = table.Column<DateTime>(type: "TEXT", nullable: false),
                    PostExpirationDate = table.Column<DateTime>(type: "TEXT", nullable: false),
                    ...
                    EmployersId = table.Column<int>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_JobPosts_Employers_EmployersId",
                        column: x => x.EmployersId,
                        principalTable: "Employers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_JobPosts_Fields_FieldId",
                        column: x => x.FieldId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobPosts_EmployersId",
                table: "JobPosts",
                column: "EmployersId");

            migrationBuilder.CreateIndex(
                name: "IX_JobPosts_FieldId",
                table: "JobPosts",
                column: "FieldId");
